...
public class ControleurUtilisateur {
    ...
    public ResponseEntity<Map<String, String>> inscrireUtilisateur(@Validated({Default.class, GroupValidationDTO.CreationUtilisateur.class}) @RequestBody UtilisateurDTO utilisateurInscrit) {
     ...
     */
    @PutMapping
    public ResponseEntity<Map<String, ?>> modifierCompte(@Validated({Default.class , GroupValidationDTO.ModificationUtilisateur.class})
